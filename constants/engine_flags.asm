...
; wDailyFlags3
	const ENGINE_GYM_REMATCH_M
	const ENGINE_GYM_REMATCH_D
	const ENGINE_GYM_REMATCH_N
	const ENGINE_MORTY_REMATCH_FIGHT
	const ENGINE_CHUCK_REMATCH_FIGHT
	const ENGINE_JASMINE_REMATCH_FIGHT
	const ENGINE_PRYCE_REMATCH_FIGHT
	const ENGINE_CLAIR_REMATCH_FIGHT
; wDailyFlags4
	const ENGINE_BROCK_REMATCH_FIGHT
	const ENGINE_MISTY_REMATCH_FIGHT
	const ENGINE_LTSURGE_REMATCH_FIGHT
	const ENGINE_ERIKA_REMATCH_FIGHT
	const ENGINE_JANINE_REMATCH_FIGHT
	const ENGINE_SABRINA_REMATCH_FIGHT
	const ENGINE_BLAINE_REMATCH_FIGHT
	const ENGINE_BLUE_REMATCH_FIGHT
; wSwarmFlags
...
; wDailyPhoneItemFlags
	...
	const ENGINE_BRENT_HAS_LINKING_CORD
