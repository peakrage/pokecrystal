...
FalknerGroup:
	...
	; FALKNER (2)
	db "FALKNER@", TRAINERTYPE_MOVES
	db  32, HOOTHOOT,  HYPNOSIS, WING_ATTACK, TAKE_DOWN, REFLECT
	db  34, PIDGEOTTO, WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db  36, PIDGEOTTO, WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db -1 ; end

	; FALKNER (3)
	db "FALKNER@", TRAINERTYPE_MOVES
	db  37, NOCTOWL,   HYPNOSIS, WING_ATTACK, CONFUSION, REFLECT
	db  37, NATU,      DRILL_PECK, CONFUSE_RAY, QUICK_ATTACK, FUTURE_SIGHT
	db  39, PIDGEOTTO, WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db  41, PIDGEOT,   WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db -1 ; end

	; FALKNER (4)
	db "FALKNER@", TRAINERTYPE_MOVES
	db  42, NOCTOWL,   HYPNOSIS, WING_ATTACK, CONFUSION, REFLECT
	db  42, DODRIO,    QUICK_ATTACK, FURY_ATTACK, MUD_SLAP, DRILL_PECK
	db  42, XATU,      DRILL_PECK, QUICK_ATTACK, FUTURE_SIGHT, PSYCHIC_M
	db  44, PIDGEOT,   WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db  46, PIDGEOT,   WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db -1 ; end

	; FALKNER (5)
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  47, DODRIO,    NO_ITEM,	   QUICK_ATTACK, TRI_ATTACK, MUD_SLAP, DRILL_PECK
	db  48, NOCTOWL,   NO_ITEM,	   REFLECT, WING_ATTACK, HYPNOSIS, DREAM_EATER
	db  49, PIDGEOT,   NO_ITEM,	   FLY, MUD_SLAP, STEEL_WING, WHIRLWIND
	db  47, XATU,      NO_ITEM,	   DRILL_PECK, QUICK_ATTACK, FUTURE_SIGHT, PSYCHIC_M
	db  51, PIDGEOT,   SHARP_BEAK,   FLY, MUD_SLAP, MIRROR_MOVE, WHIRLWIND
	db -1 ; end

	; FALKNER (6)
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  59, DODRIO,    NO_ITEM,	   QUICK_ATTACK, TRI_ATTACK, MUD_SLAP, DRILL_PECK
	db  60, NOCTOWL,   NO_ITEM,	   REFLECT, WING_ATTACK, HYPNOSIS, DREAM_EATER
	db  61, PIDGEOT,   NO_ITEM,	   FLY, MUD_SLAP, STEEL_WING, WHIRLWIND
	db  59, XATU,      NO_ITEM,	   DRILL_PECK, QUICK_ATTACK, FUTURE_SIGHT, PSYCHIC_M
	db  63, PIDGEOT,   SHARP_BEAK,   FLY, MUD_SLAP, MIRROR_MOVE, WHIRLWIND
	db -1 ; end
...
WhitneyGroup:
	...
	; WHITNEY (2)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 36, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 34, SNUBBULL,   LICK, BITE, CHARM, ROAR
	db 38, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (3)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 39, JIGGLYPUFF, BODY_SLAM, SING, ATTRACT, SWEET_KISS
	db 41, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 39, GRANBULL,   TAKE_DOWN, BITE, CHARM, ROAR
	db 43, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (4)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 44, AIPOM,      AGILITY, SWIFT, SAND_ATTACK, BATON_PASS
	db 44, JIGGLYPUFF, BODY_SLAM, SING, ATTRACT, SWEET_KISS
	db 44, GRANBULL,   TAKE_DOWN, BITE, CHARM, ROAR
	db 46, CLEFABLE,   HYPER_BEAM, MIMIC, ENCORE, METRONOME
	db 48, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (5)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 49, AIPOM,      NO_ITEM,	   AGILITY, SWIFT, THIEF, BATON_PASS
	db 49, WIGGLYTUFF, NO_ITEM,      BODY_SLAM, SING, ATTRACT, SWEET_KISS
	db 49, GRANBULL,   NO_ITEM,      TAKE_DOWN, BITE, CHARM, ROAR
	db 51, CLEFABLE,   NO_ITEM,	   HYPER_BEAM, MIMIC, ENCORE, METRONOME
	db 53, MILTANK,    PINK_BOW,	   ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (6)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 61, AIPOM,      NO_ITEM,	   AGILITY, SWIFT, THIEF, BATON_PASS
	db 61, WIGGLYTUFF, NO_ITEM,      BODY_SLAM, SING, ATTRACT, SWEET_KISS
	db 61, GRANBULL,   NO_ITEM,      TAKE_DOWN, BITE, CHARM, ROAR
	db 63, CLEFABLE,   NO_ITEM,	   HYPER_BEAM, MIMIC, ENCORE, METRONOME
	db 65, MILTANK,    PINK_BOW,	   ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	; BUGSY (2)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 35, BUTTERFREE, STUN_SPORE, SLEEP_POWDER, GUST, CONFUSION
	db 35, BEEDRILL,   FOCUS_ENERGY, PIN_MISSILE, FURY_ATTACK, PURSUIT
	db 37, SCYTHER,    QUICK_ATTACK, AGILITY, WING_ATTACK, FURY_CUTTER
	db -1 ; end

	; BUGSY (3)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 38, YANMA,	 SUPERSONIC, LEECH_LIFE, WING_ATTACK, DETECT
	db 40, BUTTERFREE, SLEEP_POWDER, GUST, PSYBEAM, WHIRLWIND
	db 40, BEEDRILL,   FOCUS_ENERGY, PIN_MISSILE, FURY_ATTACK, PURSUIT
	db 42, SCYTHER,    SLASH, AGILITY, WING_ATTACK, FURY_CUTTER
	db -1 ; end

	; BUGSY (4)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 43, YANMA,	 SUPERSONIC, LEECH_LIFE, WING_ATTACK, DETECT
	db 43, HERACROSS,  HORN_ATTACK, ENDURE, COUNTER, REVERSAL
	db 45, BUTTERFREE, SLEEP_POWDER, GIGA_DRAIN, PSYBEAM, WHIRLWIND
	db 45, BEEDRILL,   FOCUS_ENERGY, PIN_MISSILE, FURY_ATTACK, PURSUIT
	db 47, SCYTHER,    SLASH, AGILITY, WING_ATTACK, FURY_CUTTER
	db -1 ; end

	; BUGSY (5)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 48, HERACROSS,  NO_ITEM,      ENDURE, COUNTER, MEGAHORN, REVERSAL
	db 48, YANMA,	 NO_ITEM,      SUPERSONIC, LEECH_LIFE, WING_ATTACK, DETECT
	db 50, BUTTERFREE, NO_ITEM,      SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, WHIRLWIND
	db 50, BEEDRILL,   NO_ITEM,      FOCUS_ENERGY, PIN_MISSILE, FURY_ATTACK, PURSUIT
	db 52, SCYTHER,    SILVERPOWDER, SLASH, SWORDS_DANCE, WING_ATTACK, FURY_CUTTER
	db -1 ; end

	; BUGSY (6)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 60, HERACROSS,  NO_ITEM,      ENDURE, COUNTER, MEGAHORN, REVERSAL
	db 60, YANMA,	 NO_ITEM,      SUPERSONIC, LEECH_LIFE, WING_ATTACK, DETECT
	db 62, BUTTERFREE, NO_ITEM,      SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, WHIRLWIND
	db 62, BEEDRILL,   NO_ITEM,      FOCUS_ENERGY, PIN_MISSILE, FURY_ATTACK, PURSUIT
	db 64, SCYTHER,    SILVERPOWDER, SLASH, SWORDS_DANCE, WING_ATTACK, FURY_CUTTER
	db -1 ; end
...
MortyGroup:
	...
	; MORTY (2)
	db "MORTY@", TRAINERTYPE_MOVES
	db 35, HAUNTER,    LICK, SPITE, MEAN_LOOK, CURSE
	db 35, HAUNTER,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 39, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 37, HAUNTER,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end

	; MORTY (3)
	db "MORTY@", TRAINERTYPE_MOVES
	db 40, HAUNTER,    NIGHT_SHADE, SPITE, MEAN_LOOK, CURSE
	db 40, HAUNTER,    HYPNOSIS, NIGHTMARE, MIMIC, NIGHT_SHADE
	db 44, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 42, HAUNTER,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end

	; MORTY (4)
	db "MORTY@", TRAINERTYPE_MOVES
	db 44, MISDREAVUS, MEAN_LOOK, PSYWAVE, SPITE, CONFUSE_RAY
	db 45, HAUNTER,    NIGHT_SHADE, SPITE, MEAN_LOOK, CURSE
	db 45, HAUNTER,    HYPNOSIS, NIGHTMARE, MIMIC, NIGHT_SHADE
	db 49, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 47, HAUNTER,    SPITE, SHADOW_BALL, MEAN_LOOK, MIMIC
	db -1 ; end

	; MORTY (5)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 49, MISDREAVUS, NO_ITEM,	   MEAN_LOOK, PSYBEAM, DESTINY_BOND, CONFUSE_RAY
	db 50, HAUNTER,    NO_ITEM,	   THUNDERBOLT, SPITE, MEAN_LOOK, CURSE
	db 50, HAUNTER,    NO_ITEM,	   HYPNOSIS, NIGHTMARE, MIMIC, NIGHT_SHADE
	db 52, GENGAR,     NO_ITEM,	   SPITE, SHADOW_BALL, MEAN_LOOK, MIMIC
	db 54, GENGAR,     SPELL_TAG,	   HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end

	; MORTY (6)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 61, MISDREAVUS, NO_ITEM,	   MEAN_LOOK, PSYBEAM, DESTINY_BOND, CONFUSE_RAY
	db 62, HAUNTER,    NO_ITEM,	   THUNDERBOLT, SPITE, MEAN_LOOK, CURSE
	db 62, HAUNTER,    NO_ITEM,	   HYPNOSIS, NIGHTMARE, MIMIC, NIGHT_SHADE
	db 64, GENGAR,     NO_ITEM,	   SPITE, SHADOW_BALL, MEAN_LOOK, MIMIC
	db 66, GENGAR,     SPELL_TAG,	   HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	...
	; PRYCE (2)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 37, SEEL,       HEADBUTT, ICY_WIND, ICE_BEAM, REST
	db 39, DEWGONG,    HEADBUTT, ICY_WIND, ICE_BEAM, REST
	db 37, SHELLDER,   AURORA_BEAM, SUPERSONIC, WITHDRAW, PROTECT
	db 41, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end

	; PRYCE (3)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 42, DEWGONG,    TAKE_DOWN, ICY_WIND, AURORA_BEAM, REST
	db 44, DEWGONG,    SAFEGUARD, ICY_WIND, AURORA_BEAM, REST
	db 42, CLOYSTER,   CLAMP, AURORA_BEAM, PROTECT, WITHDRAW
	db 46, PILOSWINE,  FURY_ATTACK, MIST, EARTHQUAKE, BLIZZARD
	db -1 ; end

	; PRYCE (4)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 47, DEWGONG,    TAKE_DOWN, AURORA_BEAM, REST, SLEEP_TALK
	db 49, DEWGONG,    SAFEGUARD, AURORA_BEAM, REST, SNORE
	db 47, DELIBIRD,   PRESENT, ICY_WIND, RAIN_DANCE, QUICK_ATTACK
	db 47, CLOYSTER,   CLAMP, ICE_BEAM, PROTECT, WITHDRAW
	db 51, PILOSWINE,  FURY_ATTACK, MIST, EARTHQUAKE, BLIZZARD
	db -1 ; end

	; PRYCE (5)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 52, DEWGONG,    NO_ITEM,	   TAKE_DOWN, AURORA_BEAM, REST, SLEEP_TALK
	db 52, DELIBIRD, 	 NO_ITEM, 	   PRESENT, ICY_WIND, RAIN_DANCE, QUICK_ATTACK
	db 52, CLOYSTER,	 NO_ITEM,	   CLAMP, ICE_BEAM, PROTECT, WITHDRAW   
	db 54, DEWGONG,    NO_ITEM,	   SAFEGUARD, AURORA_BEAM, REST, SNORE
	db 56, PILOSWINE,  NEVERMELTICE, AMNESIA, MIST, EARTHQUAKE, BLIZZARD
	db -1 ; end

	; PRYCE (6)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 64, DEWGONG,    NO_ITEM,	   TAKE_DOWN, AURORA_BEAM, REST, SLEEP_TALK
	db 64, DELIBIRD, 	 NO_ITEM, 	   PRESENT, ICY_WIND, RAIN_DANCE, QUICK_ATTACK
	db 64, CLOYSTER,	 NO_ITEM,	   CLAMP, ICE_BEAM, PROTECT, WITHDRAW 	   
	db 66, DEWGONG,    NO_ITEM,	   SAFEGUARD, AURORA_BEAM, REST, SNORE
	db 68, PILOSWINE,  NEVERMELTICE, AMNESIA, MIST, EARTHQUAKE, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	; JASMINE (2)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 38, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 37, PINECO, 	 PROTECT, SWIFT, TAKE_DOWN, BIDE
	db 40, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 42, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end

	; JASMINE (3)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 43, MAGNETON,   THUNDERBOLT, TRI_ATTACK, SONICBOOM, THUNDER_WAVE
	db 45, MAGNETON,   THUNDERBOLT, LOCK_ON, SUPERSONIC, THUNDER_WAVE
	db 42, FORRETRESS, PROTECT, TAKE_DOWN, BIDE, EXPLOSION
	db 47, STEELIX,	 SCREECH, SUNNY_DAY, IRON_TAIL, EARTHQUAKE
	db -1 ; end

	; JASMINE (4)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 47, FORRETRESS, SUNNY_DAY, PROTECT, EXPLOSION, BIDE	
	db 48, MAGNETON,   THUNDERBOLT, TRI_ATTACK, SONICBOOM, THUNDER_WAVE
	db 50, MAGNETON,   THUNDERBOLT, LOCK_ON, SUPERSONIC, THUNDER_WAVE 
	db 52, STEELIX,    SCREECH, IRON_TAIL, EARTHQUAKE, CRUNCH
	db -1 ; end

	; JASMINE (5)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 52, SKARMORY, 	 NO_ITEM,	   STEEL_WING, AGILITY, SWIFT, PURSUIT
	db 52, FORRETRESS, NO_ITEM,	   SUNNY_DAY, PROTECT, EXPLOSION, SOLARBEAM
	db 53, MAGNETON,   NO_ITEM,	   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 55, MAGNETON,   NO_ITEM,	   ZAP_CANNON, LOCK_ON, SUPERSONIC, THUNDER_WAVE  
	db 57, STEELIX,    METAL_COAT,   SCREECH, IRON_TAIL, EARTHQUAKE, CRUNCH
	db -1 ; end

	; JASMINE (6)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 64, SKARMORY, 	 NO_ITEM,	   STEEL_WING, AGILITY, SWIFT, PURSUIT
	db 64, FORRETRESS, NO_ITEM,	   SUNNY_DAY, PROTECT, EXPLOSION, SOLARBEAM
	db 65, MAGNETON,   NO_ITEM,	   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 67, MAGNETON,   NO_ITEM,	   ZAP_CANNON, LOCK_ON, SUPERSONIC, THUNDER_WAVE 
	db 69, STEELIX,    METAL_COAT,   SCREECH, IRON_TAIL, EARTHQUAKE, CRUNCH
	db -1 ; end
...
ChuckGroup:
	...
	; CHUCK (2)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 37, TYROGUE,	 DETECT, TACKLE, ROCK_SMASH, RAPID_SPIN
	...
	; CHUCK (3)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 40, MACHOKE,	 VITAL_THROW, FORESIGHT, KARATE_CHOP, FOCUS_ENERGY
	db 43, PRIMEAPE,   SCREECH, RAGE, KARATE_CHOP, FURY_SWIPES
	db 42, HITMONTOP,	 DETECT, ROLLING_KICK, QUICK_ATTACK, RAPID_SPIN
	db 45, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK (4)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 47, HITMONTOP,	 DETECT, ROLLING_KICK, PURSUIT, RAPID_SPIN
	db 48, PRIMEAPE,   SCREECH, CROSS_CHOP, KARATE_CHOP, RAGE
	db 46, MACHAMP,	 VITAL_THROW, KARATE_CHOP, THUNDERPUNCH, FIRE_PUNCH
	db 50, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK (5)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 53, PRIMEAPE,   NO_ITEM,	   THRASH, SCREECH, CROSS_CHOP, KARATE_CHOP
	db 51, MACHOKE,	 NO_ITEM,      CROSS_CHOP, FORESIGHT, MUD_SLAP, ROCK_SLIDE
	db 53, HITMONTOP,	 NO_ITEM,	   DETECT, ROLLING_KICK, PURSUIT, RAPID_SPIN
	db 52, MACHAMP,	 NO_ITEM,	   CROSS_CHOP, KARATE_CHOP, THUNDERPUNCH, FIRE_PUNCH
	db 55, POLIWRATH,  BLACKBELT_I,  MIND_READER, SURF, DYNAMICPUNCH, BLIZZARD
	db -1 ; end

	; CHUCK (6)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 65, PRIMEAPE,   NO_ITEM,	   THRASH, SCREECH, CROSS_CHOP, KARATE_CHOP
	db 63, MACHOKE,	 NO_ITEM,      CROSS_CHOP, FORESIGHT, MUD_SLAP, ROCK_SLIDE
	db 65, HITMONTOP,	 NO_ITEM,	   DETECT, ROLLING_KICK, PURSUIT, RAPID_SPIN
	db 64, MACHAMP,	 NO_ITEM,	   CROSS_CHOP, KARATE_CHOP, THUNDERPUNCH, FIRE_PUNCH
	db 67, POLIWRATH,  BLACKBELT_I,  MIND_READER, SURF, DYNAMICPUNCH, BLIZZARD
	db -1 ; end
...
ClairGroup:
	...
	; CLAIR (2)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 40, GYARADOS,   RAIN_DANCE, TWISTER, LEER, DRAGONBREATH
	...
	; CLAIR (3)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 45, GYARADOS,   RAIN_DANCE, SURF, LEER, DRAGONBREATH
	db 47, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 47, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 48, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 50, KINGDRA,    SURF, WHIRLPOOL, HYPER_BEAM, DRAGONBREATH
	db -1 ; end

	; CLAIR (4)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 50, LAPRAS,     SAFEGUARD, RAIN_DANCE, SURF, DRAGONBREATH
	db 50, GYARADOS,   RAIN_DANCE, SURF, FIRE_BLAST, DRAGONBREATH
	db 52, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 52, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 53, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 55, KINGDRA,    SURF, WHIRLPOOL, HYPER_BEAM, DRAGONBREATH
	db -1 ; end

	; CLAIR (5)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 55, LAPRAS,	 NO_ITEM,      SAFEGUARD, RAIN_DANCE, SURF, DRAGONBREATH
	db 55, GYARADOS,   NO_ITEM,      RAIN_DANCE, SURF, FIRE_BLAST, DRAGONBREATH
	db 57, DRAGONAIR,  NO_ITEM,      THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 57, DRAGONAIR,  NO_ITEM,      THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 58, DRAGONITE,  NO_ITEM,      THUNDER_WAVE, ICE_BEAM, HYPER_BEAM, DRAGONBREATH
	db 60, KINGDRA,    DRAGON_FANG,  HYDRO_PUMP, WHIRLPOOL, HYPER_BEAM, DRAGONBREATH
	db -1 ; end

	; CLAIR (6)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 67, LAPRAS,	 NO_ITEM,      SAFEGUARD, RAIN_DANCE, SURF, DRAGONBREATH
	db 67, GYARADOS,   NO_ITEM,      RAIN_DANCE, SURF, FIRE_BLAST, DRAGONBREATH
	db 69, DRAGONAIR,  NO_ITEM,      THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 69, DRAGONAIR,  NO_ITEM,      THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 70, DRAGONITE,  NO_ITEM,      THUNDER_WAVE, ICE_BEAM, HYPER_BEAM, DRAGONBREATH
	db 72, KINGDRA,    DRAGON_FANG,  HYDRO_PUMP, WHIRLPOOL, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
BrockGroup:
	...
	db 46, RHYDON,     FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 47, OMASTAR,    BITE, SURF, PROTECT, ANCIENTPOWER
	db 49, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 47, KABUTOPS,   SURF, ENDURE, GIGA_DRAIN, ANCIENTPOWER
	db -1 ; end

	; BROCK (3)
	db "BROCK@", TRAINERTYPE_MOVES
	db 51, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 51, RHYDON,     SCARY_FACE, EARTHQUAKE, IRON_TAIL, HORN_DRILL
	db 52, OMASTAR,    BITE, SURF, PROTECT, ANCIENTPOWER
	db 54, ONIX,       BIND, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	db 52, KABUTOPS,   SURF, ENDURE, GIGA_DRAIN, ANCIENTPOWER
	db -1 ; end

	; BROCK (4)
	db "BROCK@", TRAINERTYPE_MOVES
	db 56, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 56, RHYDON,     SANDSTORM, EARTHQUAKE, IRON_TAIL, HORN_DRILL
	db 57, OMASTAR,    BITE, SURF, PROTECT, ANCIENTPOWER
	db 59, ONIX,       BIND, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	db 57, KABUTOPS,   SURF, ENDURE, GIGA_DRAIN, ANCIENTPOWER
	db -1 ; end

	; BROCK (5)
	db "BROCK@", TRAINERTYPE_ITEM_MOVES
	db 61, GOLEM,      NO_ITEM, 	    EXPLOSION, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 61, RHYDON,     NO_ITEM, 	    SANDSTORM, EARTHQUAKE, IRON_TAIL, HORN_DRILL
	db 62, OMASTAR,    NO_ITEM, 	    SURF, BLIZZARD, PROTECT, ANCIENTPOWER
	db 62, KABUTOPS,   NO_ITEM, 	    SURF, ENDURE, GIGA_DRAIN, ANCIENTPOWER
	db 64, ONIX,       HARD_STONE,    BIND, ROCK_SLIDE, EARTHQUAKE, SANDSTORM
	db -1 ; end
